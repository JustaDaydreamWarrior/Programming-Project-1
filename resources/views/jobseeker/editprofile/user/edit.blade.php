...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Edit Job Seeker Profile') }}</div>
                    ...
                    <div>
                        <form method="POST" action="{{ route('user.update') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="city" value="{{$user['city']}}" type="text"
                                           ...
                                           value="{{ old('city') }}" autocomplete="name" autofocus>
                            ...
                            <div class="form-group row">
                                <label for="experience" class="col-md-4 col-form-label text-md-right">{{ __('Experience (Years)') }}</label>

                                <div class="col-md-6">
                                    <input id="experience" value="{{ $user['experience']}}" type="text"
                            ...
                            <div class="form-group row{{ $errors->has('education') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select id="education" name="education" class="form-control" value="{{ old('education') }}"
                                            required>
