...
public class User_register {
	...
	public void goToRegisterPage() {
		...
		expectedResult = "Job Seeker Registration";
	...
	public void registerAccount() {
		...
		Select sState = new Select(driver.findElement(By.id("state")));
		sState.selectByValue("NSW");
		
		WebElement elementCity = driver.findElement(By.name("city"));
		elementCity.sendKeys("Sydney");
		...
		Select sEducation = new Select(driver.findElement(By.id("education")));
		sEducation.selectByVisibleText("Diploma");
		
		WebElement elementExperience = driver.findElement(By.name("experience"));
		elementExperience.sendKeys("2");	
		
		Actions act = new Actions(driver);
		act.moveToElement(driver.findElementById("python")).click().build().perform();
		act.moveToElement(driver.findElementById("unix")).click().build().perform();
